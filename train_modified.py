...
def main():
    ...
    parser.add_argument('--vgg', type=str, default='/home/gloriel621/StyTR-2/experiments/vgg_normalised.pth')  
    ...
    parser.add_argument('--save_model_interval', type=int, default=100000)
    ...
    for i in tqdm(range(args.max_iter)):
        ...
        out, loss_c, loss_s, l_identity1, l_identity2, clip_loss, contrastive_loss \
            = network.forward(content_images, style_images, style_labels, style_type="text")
