    ...
    def __initv2__(
        ...
        **kwargs,    
        ...
        if self.forward_core is None:
            raise ValueError(f"Invalid forward_type '{forward_type}'. Valid options are: {list(FORWARD_TYPES.keys())}")
...
class SS2DOneWay(SS2D):
    def forward_corem0(self, x: torch.Tensor = None, **kwargs):
        # Force scan_mode to "unidi"
        return super().forward_corem0(x, scan_mode="unidi", **kwargs)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            ssm_init=ssm_init,
            forward_type=forward_type,
            _SS2D=SS2DOneWay,  # Use the modified SS2D class
            mlp_ratio=mlp_ratio,
